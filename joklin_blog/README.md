joklin.com 网站源码
=================
[![ENV](https://img.shields.io/badge/python-2.7%2C3.4-blue.svg)](https://github.com/billvsme/joklin_blog)
[![LICENSE](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/billvsme/joklin_blog/blob/master/LICENSE)
[![Travis](https://img.shields.io/travis/billvsme/joklin_blog.svg)](https://travis-ci.org/billvsme/joklin_blog)
[![Docker Stars](https://img.shields.io/docker/stars/billvsme/joklin_blog.svg)](https://hub.docker.com/r/billvsme/joklin_blog/)
[![Docker Pulls](https://img.shields.io/docker/pulls/billvsme/joklin_blog.svg)](https://hub.docker.com/r/billvsme/joklin_blog/)
#有问题欢迎加qq群
joklin qq群: 458788510  
我的qq: 994171686  

[使用Docker部署joklin_blog](http://joklin.com/article/deplay_joklin_blog.html)

#更新日志
2015/5/15 从django1.6 升级到 django1.8 (还保留django1.6分支)  
2015/6/21 添加[xadmin分支](https://github.com/billvsme/joklin_blog/tree/xadmin),xadmin分支中使用xadmin作为后台管理(使用 django 1.8),如果你想后台比较漂亮可以切换到xadmin分支(注意你不需要pip install django-xadmin 但是需要安装django-crispy-forms跟django-reversion详细步骤见xadmin分支中的README)  
2015/7/5 对xadmin分支中的错误进行了比较大的修改  
2016/3/17 添加评论回复  
2016/3/22 添加Dockerfile，使用Docker部署本博客  

#概述
joklin\_blog 是一个基于  **Django1.8**  跟  **Bootstrap3**  开发的 **博客系统** ，实现了一个博客完整的功能。http://joklin.com 就是基于joklin\_blog 搭建的。
#功能
...
#预览
![首页](http://joklin.qiniudn.com/screenshot/joklin_01.jpg)
![头像](http://joklin.qiniudn.com/screenshot/joklin_02.jpg)
![评论](http://joklin.qiniudn.com/screenshot/joklin_03.jpg)
![新闻](http://joklin.qiniudn.com/screenshot/joklin_news.jpg)
...
下载代码,切换目录 :
    ...
    git clone https://github.com/billvsme/joklin_blog
    cd joklin_blog
...
```
    ...
    EMAIL_SUBJECT_PREFIX = u'joklin'        #为邮件Subject-line前缀,默认是'[django]'
...
使用docker部署，首先pull下来image或者自己使用项目中Dockerfile或者Dockerfile_cn build。
	...
	sudo docker pull billvsme/joklin_blog
然后运行image  
	例子:
